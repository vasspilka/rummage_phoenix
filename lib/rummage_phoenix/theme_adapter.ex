defmodule Rummage.Phoenix.ThemeAdapter do
  ...
  defmacro __using__(_) do
    quote do
      ...
      def pagination_links(_),
        do: raise("pagination_links/1 is Not Implemented for #{__MODULE__}")

      def page_link(_, _),
        do: raise("page_link/2 is Not Implemented for #{__MODULE__}")

      def sort_link(_, _),
        do: raise("sort_link/2 is Not Implemented for #{__MODULE__}")

      def search_form(_, _),
        do: raise("search_link/2 is Not Implemented for #{__MODULE__}")

      defoverridable pagination_links: 1, page_link: 2, sort_link: 2, search_form: 2
    end
  end
end
